...
int main(int argc, char** argv)
{
	...
	else
	{
		...
		char* trackModelName  = argv[2];
		char* trainedModeleName  = argv[3];
		
		char* findFaceOutputName = "foundFace.png";
		char* agingFaceOutputName = "agingFace.png";
		char* vFaceOutputName = "vFace.png";
		
		faceAging(imageName, trackModelName, agingFaceOutputName);
		findFace(imageName, trackModelName, findFaceOutputName);
		vFace(imageName, trackModelName, trainedModeleName, vFaceOutputName);
	}
